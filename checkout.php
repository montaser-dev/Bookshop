...
<head>
   ...
   <title>My Library / User / Checkout</title>
   ...
   <form action="" method="post">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="number" min="0" name="flat" required placeholder="Floor No.">
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            <span>City :</span>
            <input type="text" name="city" required placeholder="TAOUNATE">
         </div>
         <div class="inputBox">
            <span>State :</span>
            <input type="text" name="state" required placeholder="FES MEKNES">
         </div>
         <div class="inputBox">
            <span>Country :</span>
         ...
         <div class="inputBox">
            <span>ZIP Code :</span>
            <input type="number" min="0" name="pin_code" required placeholder="34000">
         </div>
      </div>
